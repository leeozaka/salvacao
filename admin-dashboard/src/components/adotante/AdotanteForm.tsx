...
//   const [errorPessoas, setErrorPessoas] = useState<string>("");
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setError(modoEdicao ? "Erro ao atualizar adotante." : "Erro ao cadastrar adotante.");
      console.error(err);
    } finally {
      setLoading(false);
    }
    ...
    <div className="bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  CPF {!modoEdicao ? <span className="text-red-500">*</span> : ""}
                </label>
                {!modoEdicao && (
                  <select
                    name="idPessoa"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Nome Completo {!modoEdicao ? <span className="text-red-500">*</span> : ""}
                </label>
                <input
                  type="text"
                  name="pessoa.nome"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Email {!modoEdicao ? <span className="text-red-500">*</span> : ""}
                </label>
                <input
                  type="email"
                  name="pessoa.email"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Telefone {!modoEdicao ? <span className="text-red-500">*</span> : ""}
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                    Endereço {!modoEdicao ? <span className="text-red-500">*</span> : ""}
                </label>
                <input
                    type="text"
          ...
          <div className="col-span-2">
            <h4 className="text-md font-medium text-gray-700 mb-3">Informações sobre Adoção</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="motivacaoAdocao" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div>
                    <label htmlFor="experienciaAnteriorAnimais" className="block text-sm font-medium text-gray-700 mb-1">
                        Experiência Anterior com Animais <span className="text-red-500">*</span>
                    </label>
                    <textarea
                ...
                <div>
                    <label htmlFor="tipoMoradia" className="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    >
                        ...
                        {Object.values(TipoMoradia).map((value) => (
                          <option key={value as string} value={value as string}>
                            {typeof value === 'string' ? (value as string).replace(/_/g, " ") : value}
                          </option>
                        ))}
                    </select>
                </div>
                <div className="flex items-center mt-4 md:mt-8">
                    ...
                    />
                    <label htmlFor="permiteAnimaisMoradia" className="ml-2 block text-sm font-medium text-gray-700">
